...
import { Layers, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, CheckCircle2 } from 'lucide-react';
...
function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Route user to your existing dashboard on success
        ...
        <div className="w-full max-w-md bg-white/[0.03] border border-white/10 rounded-2xl p-8 backdrop-blur-md shadow-2xl relative overflow-hidden space-y-6">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-xs text-white/50">
              Enter your credentials to access your ORQUESTRA workflow engine.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-white/10 focus:border-cyan-400/80 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder:text-white/30 outline-none focus:ring-1 focus:ring-cyan-400/40 transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="#forgot" onClick={(e) => { e.preventDefault(); alert('Demo reset link sent.'); }} className="text-[11px] text-cyan-400 hover:text-cyan-300">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-white/[0.03] border border-white/10 focus:border-cyan-400/80 rounded-xl pl-10 pr-10 py-2.5 text-sm text-white placeholder:text-white/30 outline-none focus:ring-1 focus:ring-cyan-400/40 transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-sm shadow-lg shadow-cyan-500/25 hover:scale-[1.02] hover:shadow-cyan-500/40 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          >
            ...
            <span>Launch Instant Demo Access</span>
          </button>
